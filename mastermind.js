...
MasterMind.init = function(){
  this.coloursArray = ['red','green','white','yellow','blue','pink',"purple","silver","navy","teal","olive","aqua"];
  this.currentRow   = 1;
  this.currentGuess = 1;
  this.solution     = [];
...
MasterMind.rowFinished = function(status=false){
  if(status){
    ...
    document.getElementById('heading').innerText = 'gagné !';
  } else {
    MasterMind.currentGuess = 1;
    ...
    if(MasterMind.currentRow < 9){
      ...
      MasterMind.gameInPlay = false;
      MasterMind.showSolution();
      document.getElementById('heading').innerText = 'Perdue !';
    }
  }
};
MasterMind.showRowScore = function(){
  var whiteCount = 0;
  var redCount   = 0;
  var coloursArray = ['red','green','white','yellow','blue','pink',"purple","silver","navy","teal","olive","aqua"];
  for (var i = 1; i < 5; i++) {
